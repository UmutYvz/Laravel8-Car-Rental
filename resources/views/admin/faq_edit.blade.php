        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body border">
                    <div class="card">
                        <form class="form-horizontal" action="{{ route('admin_faq_update', ['id' => $data->id]) }}"
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ $data->position }}" type="text" name="position" class="form-control"
                                            id="brand" placeholder="Position Here">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ $data->question }}" type="text" name="question" class="form-control"
                                            id="model" placeholder="Question Here">
                                    </div>
                                </div>
