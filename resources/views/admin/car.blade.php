                                        ...
                                        <table id="zero_config"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 35px;">Year</th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 80px;">Engine Power</th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 60px;">Fuel Type</th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 54px;">Color</th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 54px;">Gear Type</th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                            ...
                                            <tbody>
                                                @foreach ($dataList as $item)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td style="line-height: 40px"> {{ $item->year }} </td>
                                                        <td style="line-height: 40px"> {{ $item->engine_power }} </td>
                                                        <td style="line-height: 40px"> {{ $item->fuel_type }} </td>
                                                        <td style="line-height: 40px"> {{ $item->color }} </td>
                                                        <td style="line-height: 40px"> {{ $item->gear_type }} </td>
