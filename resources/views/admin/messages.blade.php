                                        ...
                                        <table id="zero_config"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 35px;">Subject</th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 80px;">Message</th>
                                                        <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 80px;">Admin Note</th>
                                                        <th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1"
                                                        colspan="1" aria-label="Name: activate to sort column ascending"
                                                        style="width: 32px;">Status</th>
                                            ...
                                            <tbody>
                                                @foreach ($dataList as $item)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td style="line-height: 40px"> {{ $item->subject }} </td>
                                                        <td style="line-height: 40px"> {{ $item->message }} </td>
                                                        <td style="line-height: 40px"> {{ $item->note }} </td>
                                                        ...
                                                        <td style="line-height: 40px" ><a
                                                                ...
                                                                href="{{ route('admin_message_edit', ['id' => $item->id]) }}" target="_blank">Edit</a>
                                                        </td>
                                                        <td style="line-height: 40px"><a
                                                                class="btn btn-outline-danger w-100 "
                                                                style="text-decoration: none;color:black;border-radius:7px"
                                                                href="{{ route('admin_message_delete', ['id' => $item->id]) }}"
